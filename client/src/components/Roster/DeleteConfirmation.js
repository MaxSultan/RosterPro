...
export default function DeleteConfirmation(props) {
  const finalDelete = (id) => {
    if (props.selectedRosterId) {
      ...
      props.setMessage(
        `${props.selectedAthleteFirstName} ${props.selectedAthleteLastName} was successfully deleted!`
      );
    }
  };
  return (
    <div className="delete-confirmation">
      <div>
        ...
        <p>
          ...
          {props.selectedRosterName
            ? props.selectedRosterName
            : `${props.selectedAthleteFirstName} ${props.selectedAthleteLastName}`}
          ?
        </p>
        <button
          onClick={
            props.selectedRosterId
              ? () => finalDelete(props.selectedRosterId)
              : () => finalDelete(props.selectedAthleteId)
          }
        >
          Confirm
        </button>
